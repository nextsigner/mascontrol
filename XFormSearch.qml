...
Item {
    ...
    function search(){
        ...
        if(usFormSearch.orderBy===''){
            ...
            sOrderByAndAsc+=app.colsProds[cbPor.currentIndex]+' '+ascDesc
        }
        ...
        b+='\''
        var sql='select distinct * from productos where '+b+' '+sOrderByAndAsc
        console.log('Sql: '+sql)
        ...
        for(var i=0;i<p1.length-1;i++){
            ...
            sql='select distinct * from productos where '+colSearch+' like \'%'+p1[i]+'%\' '+sOrderByAndAsc
